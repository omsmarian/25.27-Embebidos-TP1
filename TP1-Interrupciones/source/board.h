...
#define PIN_ENCODER_RSWITCH   PORTNUM2PIN(PE, 26) // PTE26
...
#define PIN_MAGCARD_ENABLE    PORTNUM2PIN(PA, 0) // PTA0
#define PIN_MAGCARD_CLOCK     PORTNUM2PIN(PA, 0) // PTA0
#define PIN_MAGCARD_DATA      PORTNUM2PIN(PA, 0) // PTA0
